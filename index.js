...
`
Statement #1:
Its better to finish work now, instead leaving for later.
`,
`
Statement #2:
I believe everyone can work as a team.
`,
`
Statement #3:
My friends say, its a lot of work to learn programming language.
`,
`
Statement #4:
People all over the world dont know much about Nicola Tesla.
favourite artists
`,
`
Statement #5:
I think I could spend all time indoors
`,
`
Statement #6:
I regularly see people who dont understand how IT systems works.
`
]
var i               = 0
...
function quizComponent () {
  ...
  function sendData(results) {
    var request  = {
      url          : 'https://results-2cf72.firebaseio.com/results.json',
      method       : 'POST',
  ...
  function createChart(ctx, myData) {
    minixhr('https://results-2cf72.firebaseio.com/results.json', responseHandler)
